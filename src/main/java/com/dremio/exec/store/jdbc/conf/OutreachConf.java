...
@SourceType(value = "OutreachARP", label = "Outreach",uiConfig = "outreach-layout.json")
public class OutreachConf extends AbstractArpConf<OutreachConf> {
  private static final String ARP_FILENAME = "arp/implementation/outreach-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.outreach.OutreachDriver";
